...
<head>
    <meta charset="utf-8">
    <title>ModelCollection - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ModelCollection</h1>
...
<header>
        ...
        ModelCollection
            ...
            <div class="class-description"><p>Collection of <code>Model</code> objects that can be interacted upon. Can contain a pager object to easily navigate
pages within the system.</p></div>
...
<article>
    ...
    <h4 class="name" id="ModelCollection"><span class="type-signature"></span>new ModelCollection<span class="signature">(modelDefinition, values, pagerData)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line35">line 35</a>
    </li></ul></dd>
...
<div class="description">
    <p>Creates a new <code>ModelCollection</code> object based on the passed <code>modelDefinition</code>. Additionally values can be added by passing
<code>Model</code> objects in the <code>values</code> parameter. The collection also exposes a pager object which can be used to navigate through
the pages in the collection. For more information see the <code>Pager</code> class.</p>
</div>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>The <code>ModelDefinition</code> that this collection is for. This defines the type of models that
are allowed to be added to the collection.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Model></span>
            ...
            <td class="description last"><p>Initial values that should be added to the collection.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>pagerData</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Object with pager data. This object contains data that will be put into the <code>Pager</code> instance.</p></td>
        </tr>
...
<h4 class="name" id="modelDefinition"><span class="type-signature"></span>modelDefinition<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line56">line 56</a>
    </li></ul></dd>
...
<h4 class="name" id="pager"><span class="type-signature"></span>pager<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line62">line 62</a>
    </li></ul></dd>
...
<span class="param-type">Pager</span>
            ...
            <td class="description last"><p>Pager object that is created from the pagerData that was passed when the collection was constructed. If no pager data was present
the pager will have default values.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line85">line 85</a>
    </li></ul></dd>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The number of Model objects that are in the collection.</p></td>
        </tr>
...
<div class="description">
    <p>Contains the number of Model objects that are in this collection. If the collection is a collection with a pager. This
does not take into account all the items in the database. Therefore when a pager is present on the collection
the size will return the items on that page. To get the total number of items consult the pager.</p>
</div>
    ...
    <h4 class="name" id="add"><span class="type-signature"></span>add<span class="signature">(value)</span><span class="type-signature"> &rarr; {ModelCollection}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line99">line 99</a>
    </li></ul></dd>
...
<div class="description">
    <p>Adds a Model instance to the collection. The model is checked if it is a correct instance of <code>Model</code> and if it has
a valid id. A valid id is a uid string of 11 alphanumeric characters.</p>
</div>
...
<dl>
    <dt>
        ...
        <p>When the passed value is not an instance of <code>Model</code></p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
    <dt>
        <div class="param-desc">
        <p>Throws error when the passed value does not have a valid id.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<span class="param-type">ModelCollection</span>
    ...
    <h4 class="name" id="clear"><span class="type-signature"></span>clear<span class="signature">()</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line141">line 141</a>
    </li></ul></dd>
...
<div class="description">
    <p>Clear the collection and remove all it's values.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollection.js.html">model/ModelCollection.js</a>, <a href="model_ModelCollection.js.html#line113">line 113</a>
    </li></ul></dd>
...
<div class="description">
    <p>If working with the Map type object is inconvenient this method can be used to return the values
of the collection as an Array object.</p>
</div>
...
<div class="param-desc">
    <p>Returns the values of the collection as an array.</p>
</div>
