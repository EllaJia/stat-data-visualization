...
<head>
    <meta charset="utf-8">
    <title>ModelDefinitions - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ModelDefinitions</h1>
...
<header>
        ...
        ModelDefinitions
            ...
            <div class="class-description"><p>Contains all the <code>ModelDefinition</code>s that are available. The definitions are properties on the object.
This would be used as a main entry point to do any interaction.</p>
<p>After calling the initialise function <code>d2({baseUrl: 'dhis/api'})</code> this object is the <code>models</code> property
that allows you to access</p></div>
...
<article>
    ...
    <h4 class="name" id="ModelDefinitions"><span class="type-signature"></span>new ModelDefinitions<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinitions.js.html">model/ModelDefinitions.js</a>, <a href="model_ModelDefinitions.js.html#line15">line 15</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>models.dataElement.getList();</code></pre>
    ...
    <h4 class="name" id="add"><span class="type-signature"></span>add<span class="signature">(modelDefinition)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinitions.js.html">model/ModelDefinitions.js</a>, <a href="model_ModelDefinitions.js.html#line28">line 28</a>
    </li></ul></dd>
...
<div class="description">
    <p>This will allow you to add your own custom ModelDefinitions.</p>
<p>The Definition object should have the following properties
<code>modelName, modelNamePlural, modelOptions, properties, validations</code></p>
</div>
    ...
    <pre class="prettyprint"><code>models.add({name: 'MyDefinition', plural: 'MyDefinitions', endPointname: '/myDefinition'});</code></pre>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>Add a model definition to the definitions collection</p></td>
        </tr>
    ...
    <h4 class="name" id="mapThroughDefinitions"><span class="type-signature"></span>mapThroughDefinitions<span class="signature">(transformer)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinitions.js.html">model/ModelDefinitions.js</a>, <a href="model_ModelDefinitions.js.html#line60">line 60</a>
    </li></ul></dd>
...
<div class="description">
    <p>Map through the modelDefinitions like you would with a simple <code>Array.map()</code></p>
</div>
    ...
    <pre class="prettyprint"><code>models.mapThroughDefinitions(definition => console.log(definition.name);</code></pre>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>Transformer function that will be run for each <code>ModelDefinition</code></p></td>
        </tr>
...
<div class="param-desc">
    <p>Array with the <code>ModelDefinition</code> objects.</p>
</div>
