...
<head>
    <meta charset="utf-8">
    <title>model/ModelValidation.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/ModelValidation.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { checkType } from '../lib/check';
