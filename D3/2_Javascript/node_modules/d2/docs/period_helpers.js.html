...
<head>
    <meta charset="utf-8">
    <title>period/helpers.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">period/helpers.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { isInteger } from '../lib/check';
