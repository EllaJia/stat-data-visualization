...
<head>
    <meta charset="utf-8">
    <title>ModelCollectionProperty - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ModelCollectionProperty</h1>
...
<header>
        ...
        ModelCollectionProperty
            ...
            <div class="class-description"><p>A ModelCollectionProperty instance is a ModelCollection that is a property of
a model instance. ModelCollectionProperties can be operated on independently of
the Model that owns them.</p></div>
...
<article>
    ...
    <h4 class="name" id="ModelCollectionProperty"><span class="type-signature"></span>new ModelCollectionProperty<span class="signature">(parentModel, modelDefinition, propName, values, api)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line11">line 11</a>
    </li></ul></dd>
...
<div class="description">
    <p>Creates a new <code>ModelCollectionProperty</code> object. This is a subclass of <code>ModelCollection</code>, which adds logic
for adding and removing elements to the collection and saving the changes to the API.</p>
<p>If the value is <code>true</code> or <code>undefined</code> is specified instead of an array of data values, this indicates that the
collection contains (or may contain) data that has not yet been loaded from the API.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>parentModel</code></td>
...
<span class="param-type">Model</span>
            ...
            <td class="description last"><p>The <code>Model</code> of the parent of this <code>ModelCollectionProperty</code></p></td>
        </tr>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>The <code>ModelDefinition</code> that this <code>ModelCollection</code> property is for</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The name of this property on the parent model</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Model></span>
|
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Initial values that should be added to the collection property</p></td>
        </tr>
...
<span class="param-type">Api</span>
            ...
            <td class="description last"><p>The class to use for API calls</p></td>
        </tr>
    ...
    <h4 class="name" id=".create"><span class="type-signature">(static) </span>create<span class="signature">(parentModel, modelDefinition, values)</span><span class="type-signature"> &rarr; {ModelCollectionProperty}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line194">line 194</a>
    </li></ul></dd>
...
<div class="description">
    <p>See <code>ModelCollectionProperty.constructor</code>.</p>
</div>
...
<span class="param-type">ModelCollectionProperty</span>
    ...
    <h4 class="name" id="add"><span class="type-signature"></span>add<span class="signature">(value)</span><span class="type-signature"> &rarr; {ModelCollectionProperty}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line63">line 63</a>
    </li></ul></dd>
...
<div class="description">
    <p>Calls the <code>add</code> method on the parent <code>ModelCollection</code> class, and then performs checks to keep track of
what, if any, changes that have been made to the collection.</p>
</div>
...
<span class="param-type">Model</span>
            ...
            <td class="description last"><p>Model instance to add to the collection.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns itself for chaining purposes.</p>
</div>
...
<span class="param-type">ModelCollectionProperty</span>
    ...
    <h4 class="name" id="isDirty"><span class="type-signature"></span>isDirty<span class="signature">(includeValues<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line129">line 129</a>
    </li></ul></dd>
...
<div class="description">
    <p>Checks if the collection property has been modified.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>includeValues</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If true, also checks if any models in the collection
has been edited by checking the dirty flag on each model.</p></td>
        </tr>
...
<div class="param-desc">
    <p>true if any elements have been added to or removed from the collection</p>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="remove"><span class="type-signature"></span>remove<span class="signature">(value)</span><span class="type-signature"> &rarr; {ModelCollectionProperty}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line88">line 88</a>
    </li></ul></dd>
...
<div class="description">
    <p>If the collection contains an object with the same id as the <code>value</code> parameter, that object is removed
...
<span class="param-type">Model</span>
            ...
            <td class="description last"><p>Model instance to remove from the collection.</p></td>
        </tr>
...
<span class="param-type">ModelCollectionProperty</span>
    ...
    <h4 class="name" id="resetDirtyState"><span class="type-signature"></span>resetDirtyState<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line117">line 117</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sets dirty=false and resets the added and removed sets used for dirty state tracking.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line144">line 144</a>
    </li></ul></dd>
...
<div class="description">
    <p>If any changes have been made to the collection, these changes will be submitted to the API. The returned
promise will resolve successfully when the changes have been saved to the API, and will be rejected if
either the changes weren't saved or if there were no changes to save.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="updateDirty"><span class="type-signature"></span>updateDirty<span class="signature">()</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelCollectionProperty.js.html">model/ModelCollectionProperty.js</a>, <a href="model_ModelCollectionProperty.js.html#line109">line 109</a>
    </li></ul></dd>
...
<div class="description">
    <p>Checks whether any changes have been made to the collection, and updates the dirty flag accordingly.</p>
</div>
...
<div class="param-desc">
    <p>True if the collection has changed, false otherwise.</p>
</div>
