...
<article>
    ...
    <h4 class="name" id="Model"><span class="type-signature"></span>new Model<span class="signature">(modelDefinition)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Model.js.html">model/Model.js</a>, <a href="model_Model.js.html#line18">line 18</a>
    </li></ul></dd>
...
<div class="description">
    <p>A Model represents an object from the DHIS2 Api. A model is created based of a ModelDefinition. The ModelDefinition
has the properties that the model should have.</p>
</div>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>The model definition that corresponds with the model.
This is essential defining what type the model is representing.</p></td>
        </tr>
    ...
    <h4 class="name" id=".create"><span class="type-signature">(static) </span>create<span class="signature">(modelDefinition)</span><span class="type-signature"> &rarr; {Model}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Model.js.html">model/Model.js</a>, <a href="model_Model.js.html#line112">line 112</a>
    </li></ul></dd>
...
<div class="description">
    <p>The static method is a factory method to create Model objects. It calls <code>new Model()</code> with the passed <code>ModelDefinition</code>.</p>
<pre class="prettyprint source lang-js"><code>let myModel = Model.create(modelDefinition);</code></pre>
</div>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>ModelDefinition from which the model should be created</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns an instance of the model.</p>
</div>
