...
<head>
    <meta charset="utf-8">
    <title>UserDataStore - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">UserDataStore</h1>
...
<article>
    ...
    <h4 class="name" id="UserDataStore"><span class="type-signature"></span>new UserDataStore<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_UserDataStore.js.html">datastore/UserDataStore.js</a>, <a href="datastore_UserDataStore.js.html#line36">line 36</a>
    </li></ul></dd>
...
<div class="description">
    <p>Represents the UserDataStore that can be interacted with. This can be used to get instances of UserDataStoreNamespace, which
can be used to interact with the <a href="module-current-user.UserDataStoreNamespace.html">namespace API</a>.</p>
<p>The store is a key-value store, where a namespace contains a list of keys, and
a key corresponds to an arbitrary JSON-object. The store is per-user, and only the currently logged-in user
has access to the namespaces.</p>
<p>Note that a namespace cannot exist without at least one key-value pair, for this reason
you need to call <a href="module-current-user.UserDataStoreNamespace.html#set">set()</a> after <a href="module-current-user.UserDataStore.html#create">create()</a> to save a namespace
with a key and a value.</p>
</div>
    ...
    <h5>Examples</h5>
        ...
        <p class="code-caption">Getting a value with promise-syntax</p>
    
    <pre class="prettyprint"><code>import { init } from 'd2';
...
init({baseUrl: 'https://play.dhis2.org/demo/api'})
  .then((d2) => {
    d2.currentUser.dataStore.get('namespace').then(namespace => {
        ...
        <p class="code-caption">Creation of namespace with async-syntax</p>
    
    <pre class="prettyprint"><code>const namespace = await d2.currentUser.dataStore.create('new namespace', false);
// The namespace is not actually created on the server before 'set' is called
await namespace.set('new key', value);</code></pre>
    ...
    <ul>
        <li><a href="module-datastore.BaseStore.html">module:datastore.BaseStore</a></li>
    </ul>
    ...
    <h4 class="name" id=".getUserDataStore"><span class="type-signature">(static) </span>getUserDataStore<span class="signature">()</span><span class="type-signature"> &rarr; {UserDataStore}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_UserDataStore.js.html">datastore/UserDataStore.js</a>, <a href="datastore_UserDataStore.js.html#line87">line 87</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get a new instance of the userDataStore object. This will function as a singleton - when a UserDataStore object has been created
when requesting getUserDataStore again, the original version will be returned.</p>
</div>
...
<div class="param-desc">
    <p>Object with the userDataStore interaction properties</p>
</div>
...
<span class="param-type">UserDataStore</span>
    ...
    <h4 class="name" id="create"><span class="type-signature"></span>create<span class="signature">(namespace)</span><span class="type-signature"> &rarr; {Promise.&lt;UserDataStoreNamespace>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_UserDataStore.js.html">datastore/UserDataStore.js</a>, <a href="datastore_UserDataStore.js.html#line73">line 73</a>
    </li></ul></dd>
    ...
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="module-datastore.BaseStore.html#create">module:datastore.BaseStore#create</a>
    </li></ul></dd>
...
<div class="description">
    <p>Creates a namespace. Ensures that the namespace does not exists on the server.
Note that for the namespace to be saved on the server, you need to call <a href="module-current-user.UserDataStoreNamespace.html#set">set</a>.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Creating a namespace</p>
    
    <pre class="prettyprint"><code>d2.currentUser.dataStore.create('new namespace').then(namespace => {
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The namespace to create.</p></td>
        </tr>
...
<div class="param-desc">
    <p>An instance of the current store-Namespace-instance representing the namespace that can be interacted with, or
an error if namespace exists.</p>
</div>
...
<span class="param-type">Promise.&lt;UserDataStoreNamespace></span>
    ...
    <h4 class="name" id="delete"><span class="type-signature"></span>delete<span class="signature">(namespace)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStore.js.html">datastore/BaseStore.js</a>, <a href="datastore_BaseStore.js.html#line102">line 102</a>
    </li></ul></dd>
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStore.html#delete">module:datastore.BaseStore#delete</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The namespace to delete.</p></td>
        </tr>
...
<div class="param-desc">
    <p>the response body from the <a href="module-api.Api.html#get">API</a>.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="get"><span class="type-signature"></span>get<span class="signature">(namespace, autoLoad<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;UserDataStoreNamespace>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_UserDataStore.js.html">datastore/UserDataStore.js</a>, <a href="datastore_UserDataStore.js.html#line57">line 57</a>
    </li></ul></dd>
    ...
    <dt class="tag-overrides">Overrides:</dt>
    <dd class="tag-overrides"><ul class="dummy"><li>
        <a href="module-datastore.BaseStore.html#get">module:datastore.BaseStore#get</a>
    </li></ul></dd>
...
<div class="description">
    <p>Tries to get the given namespace from the server, and returns an instance of 'UserDataStore' that
may be used to interact with this namespace. See <a href="module-current-user.UserDataStoreNamespace.html">UserDataStoreNamespace</a>.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Getting a namespace</p>
    
    <pre class="prettyprint"><code>d2.currentUser.dataStore.get('namespace').then(namespace => {
    namespace.set('new key', value);
});</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Namespace to get.</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If true, autoloads the keys of the namespace from the server.
If false, an instance of the namespace is returned without any keys (no request is sent to the server).</p></td>
        </tr>
...
<div class="param-desc">
    <p>An instance of a UserDataStoreNamespace representing the namespace that can be interacted with.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStore.js.html">datastore/BaseStore.js</a>, <a href="datastore_BaseStore.js.html#line63">line 63</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStore.html#getAll">module:datastore.BaseStore#getAll</a>
    </li></ul></dd>
...
<div class="description">
    <p>Retrieves a list of all namespaces on the server.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="has"><span class="type-signature"></span>has<span class="signature">(namespace)</span><span class="type-signature"> &rarr; {Promise.&lt;boolean>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStore.js.html">datastore/BaseStore.js</a>, <a href="datastore_BaseStore.js.html#line78">line 78</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStore.html#has">module:datastore.BaseStore#has</a>
    </li></ul></dd>
...
<div class="description">
    <p>Convenience method to check if a namespace exists on the server.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Namespace to check.</p></td>
        </tr>
...
<div class="param-desc">
    <p>True if namespace exists, false otherwise.</p>
</div>
