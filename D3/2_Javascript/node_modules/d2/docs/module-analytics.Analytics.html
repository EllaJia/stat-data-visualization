...
<article>
    ...
    <h4 class="name" id="Analytics"><span class="type-signature"></span>new Analytics<span class="signature">(analyticsAggregate<span class="signature-attributes">non-null</span>, analyticsEvents<span class="signature-attributes">non-null</span>, analyticsRequest<span class="signature-attributes">non-null</span>, analyticsResponse<span class="signature-attributes">non-null</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_Analytics.js.html">analytics/Analytics.js</a>, <a href="analytics_Analytics.js.html#line30">line 30</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="https://docs.dhis2.org/master/en/developer/html/webapi_analytics.html">https://docs.dhis2.org/master/en/developer/html/webapi_analytics.html</a> Analytics API documentation</li>
        
            <li><a href="https://docs.dhis2.org/master/en/developer/html/webapi_event_analytics.html">https://docs.dhis2.org/master/en/developer/html/webapi_event_analytics.html</a> Event analytics API documentation</li>
        </ul>
    </dd>
...
<div class="description">
    <p>Analytics class used to request analytics data from Web API.</p>
</div>
    ...
    <pre class="prettyprint"><code>const d2Analytics = new Analytics(
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>analyticsAggregate</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="module-analytics.AnalyticsAggregate.html">module:analytics.AnalyticsAggregate</a></span>
            ...
            <td class="description last"><p>The AnalyticsAggregate instance</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>analyticsEvents</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="module-analytics.AnalyticsEvents.html">module:analytics.AnalyticsEvents</a></span>
            ...
            <td class="description last"><p>The AnalyticsEvents instance</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>analyticsRequest</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="module-analytics.AnalyticsRequest.html">module:analytics.AnalyticsRequest</a></span>
            ...
            <td class="description last"><p>The AnalyticsRequest class</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>analyticsResponse</code></td>
            

            <td class="type">
            
                
<span class="param-type">module:analytics.AnalyticsResponse</span>
            ...
            <td class="description last"><p>The AnalyticsResponse class</p></td>
        </tr>
...
<h5>Requires:</h5>
<ul>
    <li><a href="module-analytics.AnalyticsAggregate.html">module:analytics.AnalyticsAggregate</a></li>

    <li><a href="module-analytics.AnalyticsEvents.html">module:analytics.AnalyticsEvents</a></li>

    <li><a href="module-analytics.AnalyticsRequest.html">module:analytics.AnalyticsRequest</a></li>

    <li>module:analytics.AnalyticsResponse</li>
</ul>
    ...
    <h4 class="name" id=".getAnalytics"><span class="type-signature">(static) </span>getAnalytics<span class="signature">()</span><span class="type-signature"> &rarr; {Analytics}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_Analytics.js.html">analytics/Analytics.js</a>, <a href="analytics_Analytics.js.html#line56">line 56</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get a new instance of the Analytics object. This will function as a singleton, once Analytics object
has been created when requesting getAnalytics again the original version will be returned.</p>
</div>
    ...
    <pre class="prettyprint"><code>const d2Analytics = d2.getAnalytics();</code></pre>
...
<div class="param-desc">
    <p>Object with the analytics interaction properties</p>
</div>
...
<span class="param-type">Analytics</span>
