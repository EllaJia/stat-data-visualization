...
<head>
    <meta charset="utf-8">
    <title>UserSettings - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">UserSettings</h1>
...
<article>
    ...
    <h4 class="name" id="UserSettings"><span class="type-signature"></span>new UserSettings<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="current-user_UserSettings.js.html">current-user/UserSettings.js</a>, <a href="current-user_UserSettings.js.html#line12">line 12</a>
    </li></ul></dd>
...
<div class="description">
    <p>Handles communication with the userSettings endpoint. Can be used to get or save userSettings.</p>
</div>
    ...
    <h4 class="name" id="all"><span class="type-signature"></span>all<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="current-user_UserSettings.js.html">current-user/UserSettings.js</a>, <a href="current-user_UserSettings.js.html#line33">line 33</a>
    </li></ul></dd>
...
<div class="description">
    <p>Loads all the user settings of current user and returns them as an object from the promise.</p>
<pre class="prettyprint source lang-js"><code>d2.currentUser.userSettings.all()
 .then(userSettings => {
...
<div class="param-desc">
    <p>Promise that resolves with the usersettings object from the api.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="current-user_UserSettings.js.html">current-user/UserSettings.js</a>, <a href="current-user_UserSettings.js.html#line52">line 52</a>
    </li></ul></dd>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The identifier of the user setting that should be retrieved.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A promise that resolves with the value or will fail if the value is not available.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="set"><span class="type-signature"></span>set<span class="signature">(key, value)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="current-user_UserSettings.js.html">current-user/UserSettings.js</a>, <a href="current-user_UserSettings.js.html#line97">line 97</a>
    </li></ul></dd>
...
<div class="description">
    <pre class="prettyprint source lang-js"><code>d2.currentUser.userSettings.set('keyUiLocale', 'fr')
 .then(() => {
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The identifier of the user setting that should be saved.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The new value of the user setting.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A promise that will resolve when the new value has been saved, or fail if saving fails.</p>
</div>
