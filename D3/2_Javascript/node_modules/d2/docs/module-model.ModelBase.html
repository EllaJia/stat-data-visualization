...
<head>
    <meta charset="utf-8">
    <title>ModelBase - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ModelBase</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-model.html">model</a>.</span>
        
        ModelBase
        </h2>
        
            <div class="class-description"><p>Base class that supplies functionality to the Model classes</p></div>
...
<article>
    ...
    <h4 class="name" id="ModelBase"><span class="type-signature"></span>new ModelBase<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line20">line 20</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Returns a promise that resolves when the model has been saved or rejected with the result from
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line163">line 163</a>
    </li></ul></dd>
...
<div class="description">
    <p>Deletes the object from the server.</p>
<p>This will fire a DELETE request to have the object be removed from the system.</p>
</div>
...
<div class="param-desc">
    <p>Resolves when the object was successfully deleted.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getCollectionChildren"><span class="type-signature"></span>getCollectionChildren<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;any>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line219">line 219</a>
    </li></ul></dd>
...
<div class="description">
    <p>This will return the properties that are marked as <code>owner: true</code> in the schema definition for the model.</p>
</div>
...
<div class="param-desc">
    <p>Returns an array of properties that are owned by the object</p>
</div>
...
<span class="param-type">Array.&lt;any></span>
    ...
    <h4 class="name" id="getCollectionChildrenPropertyNames"><span class="type-signature"></span>getCollectionChildrenPropertyNames<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line236">line 236</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the names of the properties that are collections on the object.</p>
<p>These are usually the properties that contain ModelCollectionProperties.</p>
</div>
...
<div class="param-desc">
    <p>A list of property names that are marked as type <code>COLLECTION</code> in the schema.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="getDirtyChildren"><span class="type-signature"></span>getDirtyChildren<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;any>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line279">line 279</a>
    </li></ul></dd>
...
<div class="description">
    <p>Returns a list of child properties that are marked as dirty. This uses the <code>getCollectionChildren()</code> method
to retrieve the children properties and then checks if they are marked as dirty.</p>
<p>The method does not check if direct properties are dirty as those are tracked on the Model itself.</p>
</div>
...
<span class="param-type">Array.&lt;any></span>
    ...
    <h4 class="name" id="getDirtyPropertyNames"><span class="type-signature"></span>getDirtyPropertyNames<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line209">line 209</a>
    </li></ul></dd>
...
<div class="description">
    <p>Returns a list of properties that have been changed.</p>
</div>
...
<div class="param-desc">
    <p>The names of the properties that were changed.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="getEmbeddedObjectCollectionPropertyNames"><span class="type-signature"></span>getEmbeddedObjectCollectionPropertyNames<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line266">line 266</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the names of the properties that are embedded objects.</p>
<p>These the properties that are not represented by a different Model, but are just plain objects that are
embedded within the current object.</p>
</div>
...
<div class="param-desc">
    <p>A list of property names of embedded objects.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="getReferenceProperties"><span class="type-signature"></span>getReferenceProperties<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line249">line 249</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets the names of the properties that are references on the object.</p>
<p>These are usually the properties that contain a Model of a different type. (e.g DataElement -&gt; CategoryCombo)</p>
</div>
...
<div class="param-desc">
    <p>A list of property names that are marked as type <code>REFERENCE</code> in the schema.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="hasDirtyChildren"><span class="type-signature"></span>hasDirtyChildren<span class="signature">()</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line289">line 289</a>
    </li></ul></dd>
...
<div class="description">
    <p>Check if any of the Model's child collections are dirty.</p>
</div>
...
<div class="param-desc">
    <p>True when one of the children is dirty.</p>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="isDirty"><span class="type-signature"></span>isDirty<span class="signature">(includeChildren)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line175">line 175</a>
    </li></ul></dd>
...
<div class="description">
    <p>Check if the model is in a dirty state and is a candidate to be saved.</p>
<p>It will check for direct properties that have been changed and if any of the children have been changed.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>includeChildren</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If set to false only the models direct properties will be checked.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns true when the model is in a dirty state.</p>
</div>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id="resetDirtyState"><span class="type-signature"></span>resetDirtyState<span class="signature">()</span><span class="type-signature"> &rarr; {ModelBase}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line186">line 186</a>
    </li></ul></dd>
...
<div class="description">
    <p>Utility method to reset the dirty state of the object.</p>
<p>This is called after a successful save operation was done.</p>
</div>
...
<div class="param-desc">
    <p>Returns itself for potential chaining</p>
</div>
...
<span class="param-type">ModelBase</span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line60">line 60</a>
    </li></ul></dd>
...
<div class="description">
    <p>Checks if the model is dirty. When the model is dirty it will check if the values of the model are valid by calling
<code>validate</code>. If this is correct it will attempt to save the <a href="#/model/Model">Model</a> to the api.</p>
<pre class="prettyprint source lang-js"><code>myModel.save()
  .then((message) => console.log(message));</code></pre>
</div>
...
<div class="param-desc">
    <p>Returns a promise that resolves when the model has been saved
or rejects with the result from the <code>validate()</code> call.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line301">line 301</a>
    </li></ul></dd>
...
<div class="description">
    <p>This method is generally intended to, by default, usefully serialize Model objects during JSON serialization.</p>
<p>This method will take all the properties that are defined on the schema and create an object with the keys and
values for those properties. This will remove any circular dependencies that could have occurred otherwise.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelBase.js.html">model/ModelBase.js</a>, <a href="model_ModelBase.js.html#line99">line 99</a>
    </li></ul></dd>
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>The api now validates the object on save, so doing the additional request to validate the object
is not very useful anymore as the validation on POST/PUT is more extensive than the /api/schemas validation.</li></ul></dd>
...
<div class="description">
    <p>This will run the validations on the properties which have validations set. Normally these validations are defined
through the DHIS2 schema. It will check min/max for strings/numbers etc. Additionally it will
run model validations against the schema.</p>
<pre class="prettyprint source lang-js"><code>myModel.validate()
 .then(myModelStatus => {
...
<div class="param-desc">
    <p>Promise that resolves with an object with a status property that represents if the model
is valid or not the fields array will return the names of the fields that are invalid.</p>
</div>
