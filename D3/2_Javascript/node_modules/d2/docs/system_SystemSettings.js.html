...
<head>
    <meta charset="utf-8">
    <title>system/SystemSettings.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">system/SystemSettings.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { isString } from '../lib/check';
