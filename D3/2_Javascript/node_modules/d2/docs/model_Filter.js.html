...
<head>
    <meta charset="utf-8">
    <title>model/Filter.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/Filter.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { checkDefined } from '../lib/check';
