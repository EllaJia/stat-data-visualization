...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-d2.html">d2</a><a href="module-d2.html#.init">.init</a>~</span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line156">line 156</a>
    </li></ul></dd>
...
<h4 class="name" id="analytics"><span class="type-signature"></span>analytics<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line240">line 240</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="module-analytics.Analytics.html">Analytics</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>Analytics instance for requesting analytics data from various endpoints.</p>
</div>
    ...
    <pre class="prettyprint"><code>d2.analytics.aggregate
 .addDimensions([
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line187">line 187</a>
    </li></ul></dd>
...
<div class="description">
    <p>Api class that is used throughout the api interaction. This can be used to get hold of the module:Api singleton.</p>
</div>
    ...
    <pre class="prettyprint"><code>d2.Api.getApi()      // Returns the api object
...
<h4 class="name" id="currentUser"><span class="type-signature"></span>currentUser<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line341">line 341</a>
    </li></ul></dd>
...
<div class="description">
    <p>An instance of CurrentUser</p>
<p>The currentUser can be used to retrieve data related to the currentUser.</p>
<p>These things primarily include:</p>
<ul>
<li>currentUser properties retrieved from <code>/api/me</code></li>
<li>Lazily request collections related to the user such as<ul>
<li>userRoles</li>
<li>userGroups</li>
<li>organisationUnits</li>
<li>dataViewOrganisationUnits</li>
</ul>
</li>
<li>authorities</li>
<li>userSettings</li>
<li>utility methods for ACL</li>
</ul>
</div>
    ...
    <pre class="prettyprint"><code>d2.currentUser.canCreate(d2.models.dataElement); // Returns true when the user can create either a private/public dataElement
d2.currentUser.canCreate(d2.models.organisationUnit); // Returns true the user can create an organisationUnit</code></pre>



        
            
<h4 class="name" id="dataStore"><span class="type-signature"></span>dataStore<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line218">line 218</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="module-datastore.DataStore.html">DataStore</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>Instance of the DataStore class for interaction with the dataStore api.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line210">line 210</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="module-i18n-I18n.html#getTranslation">getTranslation</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>I18n instance with the loaded translations.</p>
<p>Usually used for retrieving translations for a given key using <code>getTranslation(key: string)</code></p>
</div>
    ...
    <pre class="prettyprint"><code>d2.i18n.getTranslation('success'); // Returns "Success" for the english locale</code></pre>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line172">line 172</a>
    </li></ul></dd>
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>There is probably no point to expose this.</li></ul></dd>
...
<div class="description">
    <p>Collection of the <a href="module-model.html">module:model</a> classes</p>
</div>
...
<h4 class="name" id="models"><span class="type-signature"></span>models<span class="type-signature"> :Object.&lt;string, ModelDefinition></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line165">line 165</a>
    </li></ul></dd>
...
<div class="description">
    <p>This is the entry point for the modelDefinitions that were loaded. To start interacting with the metadata api
you would pick a modelDefinition from this object to interact with.</p>
</div>
...
<span class="param-type">Object.&lt;string, ModelDefinition></span>
...
<h4 class="name" id="system"><span class="type-signature"></span>system<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line197">line 197</a>
    </li></ul></dd>
...
<div class="description">
    <p>System instance to interact with system information like system settings, system info etc.</p>
</div>
    ...
    <pre class="prettyprint"><code>console.log(d2.system.version.major); // 2 for DHIS 2.27</code></pre>
