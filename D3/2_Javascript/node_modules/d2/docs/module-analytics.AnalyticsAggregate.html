...
<head>
    <meta charset="utf-8">
    <title>AnalyticsAggregate - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">AnalyticsAggregate</h1>
...
<article>
    ...
    <h4 class="name" id="AnalyticsAggregate"><span class="type-signature"></span>new AnalyticsAggregate<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsAggregate.js.html">analytics/AnalyticsAggregate.js</a>, <a href="analytics_AnalyticsAggregate.js.html#line13">line 13</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="https://docs.dhis2.org/master/en/developer/html/webapi_analytics.html">https://docs.dhis2.org/master/en/developer/html/webapi_analytics.html</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>Analytics aggregate class used to request aggregate analytics data from Web API.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getDataValueSet"><span class="type-signature"></span>getDataValueSet<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsAggregate.js.html">analytics/AnalyticsAggregate.js</a>, <a href="analytics_AnalyticsAggregate.js.html#line31">line 31</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves with the analytics data value set data from the API.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getDebugSql"><span class="type-signature"></span>getDebugSql<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsAggregate.js.html">analytics/AnalyticsAggregate.js</a>, <a href="analytics_AnalyticsAggregate.js.html#line74">line 74</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves with the SQL statement used to query the database.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getRawData"><span class="type-signature"></span>getRawData<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsAggregate.js.html">analytics/AnalyticsAggregate.js</a>, <a href="analytics_AnalyticsAggregate.js.html#line53">line 53</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves with the raw data from the API.</p>
</div>
