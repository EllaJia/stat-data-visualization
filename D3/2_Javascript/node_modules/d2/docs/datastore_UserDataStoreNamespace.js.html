...
<head>
    <meta charset="utf-8">
    <title>datastore/UserDataStoreNamespace.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">datastore/UserDataStoreNamespace.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import Api from '../api/Api';
