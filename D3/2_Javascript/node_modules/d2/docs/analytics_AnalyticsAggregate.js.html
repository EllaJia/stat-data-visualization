...
<head>
    <meta charset="utf-8">
    <title>analytics/AnalyticsAggregate.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">analytics/AnalyticsAggregate.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import AnalyticsBase from './AnalyticsBase';
