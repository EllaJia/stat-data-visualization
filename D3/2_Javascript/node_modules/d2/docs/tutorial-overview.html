...
<head>
    <meta charset="utf-8">
    <title>Tutorial: overview - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Tutorial: overview</h1>
...
<article>
    <h2>D2</h2><p>The d2 library is a javascript library that abstacts away the dhis2 api and lets you use javascript models to communicate with your dhis2 server.</p>
<p>At the moment it allows you to work with:</p>
<ul>
<li>The metadata endpoints</li>
<li>A selection of the &quot;other&quot; endpoints (non-metadata/data related endpoints)</li>
</ul>
<p>The &quot;other&quot; endpoints are:</p>
<ul>
<li>system System<ul>
<li>info</li>
<li>settings (<a href="module-system.SystemSettings.html">SystemSettings</a>)</li>
<li>configuration (<a href="module-system.SystemConfiguration.html">SystemConfiguration</a>)</li>
</ul>
</li>
<li>me (currentUser) (<a href="module-current-user.CurrentUser.html">CurrentUser</a>)<ul>
<li>authorization (<a href="module-current-user.UserAuthorities.html">UserAuthorities</a>)</li>
</ul>
</li>
<li>i18n</li>
<li>data store</li>
</ul>
<h2>Initialisation</h2><p>d2 requires an initialisation step to be able to use some the functionality. To initialise
the library one calls the <a href="module-d2.html#.init">init</a> function.</p>
<p>The most basic usage of the init function would look like.</p>
<pre class="prettyprint source lang-js"><code>import { init } from 'd2/lib/d2';

init({ baseUrl: 'https://play.dhis2.org/demo/api' });</code></pre><p>We import the <a href="module-d2.html#.init">init</a> function from the d2 library and call it with a config object.</p>
<p>The config object takes the following properties</p>
<table>
<thead>
<tr>
<th>option</th>
...
<td>baseUrl</td>
<td>string</td>
<td>The location of the dhis2 api. Note that this always needs to end with <code>/api</code></td>
</tr>
<tr>
<td>schemas</td>
<td>array</td>
<td>Pass a list of <a href="https://play.dhis2.org/demo/api/schemas.json?fields=name,metadata">schema</a> names. (only metadata schemas are supported.) Passing an empty array will result into no schemas being loaded. The default is to load all schemas.</td>
</tr>
<tr>
<td>headers</td>
<td>object</td>
<td>A map of default headers that should be set on each http request. This is passed into <code>setDefaultHeaders</code> on the Api class</td>
</tr>
</tbody>
</table>
<h2>The d2 object and <code>getInstance</code></h2><p>During the initialisation the <a href="module-d2.init-d2.html">d2</a> object is created. The <a href="module-d2.html#.init">init</a> function returns a promise
that returns the <a href="module-d2.init-d2.html">d2</a> object. However you might want to get a hold of the same object in other places in your application
You could store the instance somewhere and keep track of it, however that does not guarantee that it's available.</p>
<p>To be able to get a hold of the instance, when it is ready, you can use the <a href="module-d2.html#.getInstance">getInstance</a> function.</p>
<pre class="prettyprint source lang-js"><code>// File init.js
...
getInstance()
    ...
    });</code></pre><p>For a more elaborate description on whats available on the d2 object see the <a href="module-d2.init-d2.html">d2 namespace</a></p>
</article>
