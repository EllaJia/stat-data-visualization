...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Module that contains the entry points for working with the d2 instance. Most of the api related functionality will be available through this package.</p>
<p>The most important functions from the module are <a href="module-d2.html#.init">init</a> and <a href="module-d2.html#.init">getInstance</a> these are used to create and to get
a hold of the initialized instance of <a href="module-d2.init-d2.html">d2</a>. The initialized instance is the object that allows you access most of d2's functionality.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>import { init } from 'd2/lib/d2';

init({ baseUrl: 'https://play.dhis2.org/demo/api/27/' })
 .then(d2 => console.log(d2.currentUser.name));</code></pre>
...
<h4 class="name" id=".config"><span class="type-signature">(static, constant) </span>config<span class="type-signature"> :Config</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line405">line 405</a>
    </li></ul></dd>
...
<div class="description">
    <p>Can be used to set config options before initialisation of d2.</p>
</div>
...
<span class="param-type">Config</span>
    ...
    <pre class="prettyprint"><code>import {config, init} from 'd2';
...
init()
  .then(d2 => {
    ...
    <h4 class="name" id=".getInstance"><span class="type-signature">(static) </span>getInstance<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;D2>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line377">line 377</a>
    </li></ul></dd>
...
<div class="description">
    <p>This function can be used to retrieve the <code>singleton</code> instance of d2. The instance is being created by calling
the <code>init</code> method.</p>
    ...
    <pre class="prettyprint"><code>import {init, getInstance} from 'd2';
...
<div class="param-desc">
    <p>A promise to the initialized <a href="module-d2.init-d2.html">d2</a> instance.</p>
</div>
...
<span class="param-type">Promise.&lt;D2></span>
    ...
    <h4 class="name" id=".getManifest"><span class="type-signature">(static) </span>getManifest<span class="signature">(url, ApiClass<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line54">line 54</a>
    </li></ul></dd>
...
<div class="description">
    <p>Utility function to load the app manifest.</p>
<p>The manifest well be enhanced with a <code>getBaseUrl()</code> utility function that will return the base url of the DHIS2 instance.
This is a simple getter for the <code>activities.dhis.href</code> property on the manifest.</p>
</div>
    ...
    <pre class="prettyprint"><code>import { getManifest } from 'd2/lib/d2';
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The location of the manifest. Generally this is located in the root of your app folder. (e.g. './manifest.webapp)</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>ApiClass</code></td>
...
<span class="param-type">Api</span>
            ...
            <td class="description last"><p>An implementation of the Api class that will be used to fetch the manifest.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns a Promise to  the DHIS2 app manifest with the added <code>getBaseUrl</code> method.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id=".init"><span class="type-signature">(static) </span>init<span class="signature">(initConfig)</span><span class="type-signature"> &rarr; {Promise.&lt;D2>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line148">line 148</a>
    </li></ul></dd>
...
<div class="description">
    <p>Init function that used to initialise <a href="module-d2.init-d2.html">d2</a>. This will load the schemas from the DHIS2 api and configure your <a href="module-d2.init-d2.html">d2</a> instance.</p>
<p>The <code>config</code> object that can be passed into init can have the following properties:</p>
<p>baseUrl: Set this when the url is something different then <code>/api</code>. If you are running your dhis instance in a subdirectory of the actual domain
for example http://localhost/dhis/ you should set the base url to <code>/dhis/api</code></p>
<p>unauthorizedCb: A callback function that is called whenever a API-request encounters a 401 - Unauthorized response.
 The function is called with (request, response) - the request object that failed, and the parsed response from the server.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>initConfig</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Configuration object that will be used to configure to define D2 Setting.
See the description for more information on the available settings.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A promise that resolves with the intialized d2 object.</p>
</div>
...
<span class="param-type">Promise.&lt;D2></span>
    ...
    <h4 class="name" id="~getUserSettings"><span class="type-signature">(inner) </span>getUserSettings<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="d2.js.html">d2.js</a>, <a href="d2.js.html#line69">line 69</a>
    </li></ul></dd>
...
<div class="description">
    <p>The object that is the result of the promise will have the following properties</p>
</div>
    ...
    <pre class="prettyprint"><code>import {getUserSettings} from 'd2/lib/d2';
...
<div class="param-desc">
    <p>A promise to the current user settings</p>
</div>
