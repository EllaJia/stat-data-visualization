...
<head>
    <meta charset="utf-8">
    <title>datastore/UserDataStore.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">datastore/UserDataStore.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import BaseStore from './BaseStore';
