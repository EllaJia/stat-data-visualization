...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-api.html">api</a>.</span>
...
<article>
    ...
    <h4 class="name" id="Api"><span class="type-signature"></span>new Api<span class="signature">(fetchImpl<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line60">line 60</a>
    </li></ul></dd>
...
<div class="description">
    <p>Used for interaction with the dhis2 api.</p>
<p>This class is used as the backbone for d2 and handles all the interaction with the server. There is a singleton
available to be reused across your applications. The singleton can be grabbed from the d2 instance. The api methods all handle URL-encoding for you, so you can just pass them unencoded strings</p>
<pre class="prettyprint source lang-js"><code>import { getInstance } from 'd2/lib/d2';
...
getInstance()
 .then(d2 => {
     ...
     api.get('resources');
 });</code></pre><p>Uses <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API">Fetch</a> to do network requests.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>fetchImpl</code></td>
...
<span class="param-type">Fetch</span>
            ...
            <td class="description last"><p>The fetch implementation to use. Can be used to pass a different implementation
similar to the fetch Api. Will default to <code>window.fetch</code> in a browser context.</p></td>
        </tr>
    ...
    <h4 class="name" id="get"><span class="type-signature"></span>get<span class="signature">(url, data, options)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line131">line 131</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The url for the request, should be unencoded. Will return a rejected promise for malformed urls and urls that contain encoded query strings.</p></td>
        </tr>
...
<span class="param-type">*</span>
            ...
            <td class="description last"><p>Any data that should be sent with the request. For a GET request these are encoded and turned into
query parameters. For POST and PUT requests it becomes the body.</p></td>
        </tr>
...
<span class="param-type">Object.&lt;string, any></span>
            ...
            <td class="description last"><p>The request options are passed as options to the fetch request.
These options are passed as the <a href="https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters">init</a>
parameter to the fetch request.</p></td>
        </tr>
...
<span class="param-type">Promise.&lt;*></span>
    ...
    <h4 class="name" id="patch"><span class="type-signature"></span>patch<span class="signature">(url, data)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line217">line 217</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The url for the request</p></td>
        </tr>
...
<span class="param-type">*</span>
            ...
            <td class="description last"><p>Any data that should be send with the request. This becomes the body of the PATCH request.</p></td>
        </tr>
...
<span class="param-type">Promise.&lt;*></span>
    ...
    <h4 class="name" id="post"><span class="type-signature"></span>post<span class="signature">(url, data, options)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line147">line 147</a>
    </li></ul></dd>
...
<span class="param-type">*</span>
            ...
            <td class="description last"><p>Any data that should be send with the request this becomes the body for the POST request</p></td>
        </tr>
...
<span class="param-type">Promise.&lt;*></span>
    ...
    <h4 class="name" id="setBaseUrl"><span class="type-signature"></span>setBaseUrl<span class="signature">(baseUrl)</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line394">line 394</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sets the baseUrl that should be used for the api.</p>
<p>When working against the dhis2 demo instance at <a href="https://play.dhis2.org/demo">https://play.dhis2.org/demo</a> the
baseUrl would be set as <code>https://play.dhis2.org/demo/api</code>.</p>
<p>This method is used when calling the <code>d2.init</code> method with the <code>baseUrl</code> config property
to configure the Api singleton.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The base url to be used for the API.</p></td>
        </tr>
...
<span class="param-type">this</span>
    ...
    <h4 class="name" id="setDefaultHeaders"><span class="type-signature"></span>setDefaultHeaders<span class="signature">(headers)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line102">line 102</a>
    </li></ul></dd>
...
<div class="description">
    <p>Used for setting default headers that should be send with every request.</p>
</div>
    ...
    <pre class="prettyprint"><code>const api = Api.getApi();
...
<span class="param-type">Object.&lt;string, string></span>
            ...
            <td class="description last"><p>Default headers that should be set on every request.</p></td>
        </tr>
    ...
    <h4 class="name" id="setUnauthorizedCallback"><span class="type-signature"></span>setUnauthorizedCallback<span class="signature">(cb)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line112">line 112</a>
    </li></ul></dd>
...
<div class="description">
    <p>When any request encounters a 401 - Unauthorized. This callback is called.
Useful for when you want an session expiration-handler API-wide.</p>
</div>
...
<span class="param-type">*</span>
            ...
            <td class="description last"><p>Function to call when any request recieves a 401. Called with the response from the server.</p></td>
        </tr>
    ...
    <h4 class="name" id="update"><span class="type-signature"></span>update<span class="signature">(url, data, useMergeStrategy<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_Api.js.html">api/Api.js</a>, <a href="api_Api.js.html#line197">line 197</a>
    </li></ul></dd>
...
<span class="param-type">*</span>
            ...
            <td class="description last"><p>Any data that should be send with the request. This becomes the body of the PUT request.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>useMergeStrategy</code></td>
