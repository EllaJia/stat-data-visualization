...
<head>
    <meta charset="utf-8">
    <title>pager/Pager.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">pager/Pager.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { isDefined } from '../lib/check';
