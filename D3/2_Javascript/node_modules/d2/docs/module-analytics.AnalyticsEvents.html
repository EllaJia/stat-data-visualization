...
<head>
    <meta charset="utf-8">
    <title>AnalyticsEvents - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">AnalyticsEvents</h1>
...
<article>
    ...
    <h4 class="name" id="AnalyticsEvents"><span class="type-signature"></span>new AnalyticsEvents<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsEvents.js.html">analytics/AnalyticsEvents.js</a>, <a href="analytics_AnalyticsEvents.js.html#line13">line 13</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="https://docs.dhis2.org/master/en/developer/html/webapi_event_analytics.html">https://docs.dhis2.org/master/en/developer/html/webapi_event_analytics.html</a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>Analytics events class used to request analytics events data from Web API.</p>
</div>
    ...
    <ul>
        <li><a href="module-analytics.AnalyticsBase.html">module:analytics.AnalyticsBase</a></li>
    </ul>
    ...
    <h4 class="name" id="get"><span class="type-signature"></span>get<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsBase.js.html">analytics/AnalyticsBase.js</a>, <a href="analytics_AnalyticsBase.js.html#line46">line 46</a>
    </li></ul></dd>
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-analytics.AnalyticsBase.html#get">module:analytics.AnalyticsBase#get</a>
    </li></ul></dd>
...
<div class="description">
    <p>Loads the analytics data and returns them as an object from the promise.
...
This methods takes care of adding the default extra parameters to both requests.</p>
</div>
...
// { metaData: { ... }, rows: [ ... ], headers: [ ... ], height: 0, width: 0 }</code></pre>
...
<span class="param-type">AnalyticsRequest</span>
            ...
            <td class="description last"><p>Analytics request object with the request details</p></td>
        </tr>
...
<div class="param-desc">
    <p>Promise that resolves with the analytics data and metaData from the api.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getAggregate"><span class="type-signature"></span>getAggregate<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsEvents.js.html">analytics/AnalyticsEvents.js</a>, <a href="analytics_AnalyticsEvents.js.html#line32">line 32</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves with the analytics aggregate data from the api.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getCluster"><span class="type-signature"></span>getCluster<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsEvents.js.html">analytics/AnalyticsEvents.js</a>, <a href="analytics_AnalyticsEvents.js.html#line79">line 79</a>
    </li></ul></dd>
...
<span class="param-type">AnalyticsRequest</span>
            ...
            <td class="description last"><p>Request object
Must contain clusterSize and bbox parameters.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Promise that resolves with the analytics cluster data from the api.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getCount"><span class="type-signature"></span>getCount<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsEvents.js.html">analytics/AnalyticsEvents.js</a>, <a href="analytics_AnalyticsEvents.js.html#line54">line 54</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves with the analytics count data from the api.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getQuery"><span class="type-signature"></span>getQuery<span class="signature">(req<span class="signature-attributes">non-null</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="analytics_AnalyticsEvents.js.html">analytics/AnalyticsEvents.js</a>, <a href="analytics_AnalyticsEvents.js.html#line101">line 101</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Promise that resolves with the analytics query data from the api.</p>
</div>
