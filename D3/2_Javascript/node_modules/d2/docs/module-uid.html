...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Client side implementation of the DHIS2 code (uid) generator.
(<a href="https://github.com/dhis2/dhis2-core/blob/ad2d5dea959aff3146d8fe5796cf0b75eb6ee5d8/dhis-2/dhis-api/src/main/java/org/hisp/dhis/common/CodeGenerator.java">CodeGenerator.java</a>)</p>
<p>This module is used to generate and validate DHIS2 uids. A valid DHIS2 uid is a 11 character string which starts with a letter from the ISO basic Latin alphabet.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="uid.js.html">uid.js</a>, <a href="uid.js.html#line1">line 1</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".generateUid"><span class="type-signature">(static) </span>generateUid<span class="signature">()</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="uid.js.html">uid.js</a>, <a href="uid.js.html#line36">line 36</a>
    </li></ul></dd>
...
<div class="description">
    <p>Generate a valid DHIS2 uid. A valid DHIS2 uid is a 11 character string which starts with a letter from the ISO basic Latin alphabet.</p>
</div>
    ...
    <pre class="prettyprint"><code>import { generateUid } from 'd2/lib/uid';

generateUid();</code></pre>
...
<div class="param-desc">
    <p>A 11 character uid that always starts with a letter.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".isValidUid"><span class="type-signature">(static) </span>isValidUid<span class="signature">(code)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="uid.js.html">uid.js</a>, <a href="uid.js.html#line61">line 61</a>
    </li></ul></dd>
...
<div class="description">
    <p>Tests whether the given code is valid.</p>
</div>
    ...
    <pre class="prettyprint"><code>import { isValidUid } from 'd2/lib/uid';

isValidUid('JkWynlWMjJR'); // true
isValidUid('0kWynlWMjJR'); // false (Uid can not start with a number)
isValidUid('AkWy$lWMjJR'); // false (Uid can only contain alphanumeric characters.</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The code to validate.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns true if the code is valid, false otherwise.</p>
</div>
