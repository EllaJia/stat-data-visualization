...
<head>
    <meta charset="utf-8">
    <title>analytics/AnalyticsRequestDimensionsMixin.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">analytics/AnalyticsRequestDimensionsMixin.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import AnalyticsRequest from './AnalyticsRequest';
