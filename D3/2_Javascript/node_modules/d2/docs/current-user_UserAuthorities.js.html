...
<head>
    <meta charset="utf-8">
    <title>current-user/UserAuthorities.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">current-user/UserAuthorities.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const auths = Symbol('authorities');
