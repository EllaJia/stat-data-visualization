...
<head>
    <meta charset="utf-8">
    <title>model/Filters.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/Filters.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { isType, checkValidRootJunction } from '../lib/check';
