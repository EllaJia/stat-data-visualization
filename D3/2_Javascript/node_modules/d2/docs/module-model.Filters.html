...
<article>
    ...
    <h4 class="name" id="Filters"><span class="type-signature"></span>new Filters<span class="signature">(modelDefinition, filters)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line11">line 11</a>
    </li></ul></dd>
...
<div class="description">
    <p>Collection class that contains filters that are to be applied when loading Model objects from the api.</p>
</div>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>The ModelDefinition for which this Filters object should create filters.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Filter></span>
            ...
            <td class="description last"><p>A list of Filter objects</p></td>
        </tr>
    ...
    <h4 class="name" id=".getFilters"><span class="type-signature">(static) </span>getFilters<span class="signature">(modelDefinition, priorFilters)</span><span class="type-signature"> &rarr; {Filters}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line128">line 128</a>
    </li></ul></dd>
...
<div class="description">
    <p>Factory method to create a Filters object.</p>
</div>
...
<span class="param-type">ModelDefinition</span>
            ...
            <td class="description last"><p>The modelDefinition that the filters should apply to.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>priorFilters</code></td>
...
<span class="param-type">Array.&lt;Filter></span>
            ...
            <td class="description last"><p>List of previously applied filters that the new filter list should start with.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A Filters object for the given modelDefinition.</p>
</div>
...
<span class="param-type">Filters</span>
    ...
    <h4 class="name" id="getFilterList"><span class="type-signature"></span>getFilterList<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;Filter>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line97">line 97</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get a list of Filter objects that are in applied in this Filters instance</p>
</div>
...
<div class="param-desc">
    <p>The list of Filter objects.</p>
</div>
...
<span class="param-type">Array.&lt;Filter></span>
    ...
    <h4 class="name" id="getFilters"><span class="type-signature"></span>getFilters<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line88">line 88</a>
    </li></ul></dd>
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>Deprecated since 2.28, use getQueryFilterValues instead.</li></ul></dd>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="getQueryFilterValues"><span class="type-signature"></span>getQueryFilterValues<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line80">line 80</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get an array of DHIS2 metadata filter values to send to the API.</p>
<p>This will return ['id:eq:UYXOT4A7JMI', 'name:like:ANC'] for filters created as follows
dataElement
 .filter().on('id').equals(UYXOT4A7JMI)
 .filter().on('name').like('ANC')</p>
</div>
...
<div class="param-desc">
    <p>A list of query param values to be used with the filter key.</p>
</div>
...
<span class="param-type">Array.&lt;string></span>
    ...
    <h4 class="name" id="list"><span class="type-signature"></span>list<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line66">line 66</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Proxy the list() call on the filters object.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="logicMode"><span class="type-signature"></span>logicMode<span class="signature">(junction)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line115">line 115</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="https://docs.dhis2.org/master/en/developer/html/webapi_metadata_object_filter.html">Object filter Docs </a></li>
        </ul>
    </dd>
...
<div class="description">
    <p>The logic mode to use on the filters.</p>
<p>Default behavior is AND.
...
through modelDefinition.filter().</p>
</div>
    ...
    <pre class="prettyprint"><code>d2.programs.filter().on('name').like('Child')
.filter().logicMode('OR').on('code').equals('Child')</code></pre>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>junction</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The logic operator to use. One of ['OR', 'AND'];</p></td>
        </tr>
    ...
    <h4 class="name" id="on"><span class="type-signature"></span>on<span class="signature">(propertyName)</span><span class="type-signature"> &rarr; {Filter}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_Filters.js.html">model/Filters.js</a>, <a href="model_Filters.js.html#line38">line 38</a>
    </li></ul></dd>
...
<div class="description">
    <p>Shortcut for triggering the creation of a Filter. This is the function that is triggered when creating new
filters on a ModelDefinition. The Filter will receive a callback that can be used to add the finalized filter
to the list of filters.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The property that the filter should apply to. (e.g. <code>name</code>)</p></td>
        </tr>
...
<div class="param-desc">
    <p>The created filter object for <code>propertyName</code>.</p>
</div>
