...
<div id="main">
    ...
    <h1 class="page-title">DataStore</h1>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_DataStore.js.html">datastore/DataStore.js</a>, <a href="datastore_DataStore.js.html#line30">line 30</a>
    </li></ul></dd>
...
<div class="description">
    <p>Represents the dataStore that can be interacted with. This can be used to get instances of DataStoreNamespace, which
can be used to interact with the <a href="module-datastore.DataStoreNamespace.html">namespace API</a>.</p>
<p>The store is a key-value store, where a namespace contains a list of keys, and
a key corresponds to an arbitrary JSON-object. The dataStore is DHIS2-instance wide.</p>
<p>Note that a namespace cannot exist without at least one key-value pair, for this reason
you need to call <a href="module-datastore.DataStoreNamespace.html#set">set()</a> after <a href="module-datastore.DataStore.html#create">create()</a> to save a namespace
...
init({baseUrl: 'https://play.dhis2.org/demo/api'})
  .then((d2) => {
    ...
    <h4 class="name" id=".getDataStore"><span class="type-signature">(static) </span>getDataStore<span class="signature">()</span><span class="type-signature"> &rarr; {DataStore}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_DataStore.js.html">datastore/DataStore.js</a>, <a href="datastore_DataStore.js.html#line79">line 79</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get a new instance of the dataStore object. This will function as a singleton, when a DataStore object has been created
when requesting getDataStore again the original version will be returned.</p>
</div>
...
<div class="param-desc">
    <p>Object with the dataStore interaction properties</p>
</div>
...
<span class="param-type">DataStore</span>
    ...
    <h4 class="name" id="create"><span class="type-signature"></span>create<span class="signature">(namespace)</span><span class="type-signature"> &rarr; {Promise.&lt;DataStoreNamespace>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_DataStore.js.html">datastore/DataStore.js</a>, <a href="datastore_DataStore.js.html#line66">line 66</a>
    </li></ul></dd>
...
Note that for the namespace to be saved on the server, you need to call <a href="module-datastore.DataStoreNamespace.html#set">set</a>.</p>
</div>
    ...
    <pre class="prettyprint"><code>d2.dataStore.create('new namespace').then(namespace => {
...
<span class="param-type">Promise.&lt;DataStoreNamespace></span>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="get"><span class="type-signature"></span>get<span class="signature">(namespace, autoLoad<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;DataStoreNamespace>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_DataStore.js.html">datastore/DataStore.js</a>, <a href="datastore_DataStore.js.html#line50">line 50</a>
    </li></ul></dd>
...
<div class="description">
    <p>Tries to get the given namespace from the server, and returns an instance of DataStore that
may be used to interact with this namespace. See <a href="module-datastore.DataStoreNamespace.html">DataStore</a>.</p>
</div>
    ...
    <pre class="prettyprint"><code>d2.dataStore.get('namespace').then(namespace => {
    namespace.set('new key', value);
});</code></pre>
...
<div class="param-desc">
    <p>An instance of a DataStore representing the namespace that can be interacted with,
or an error if namespace exists.</p>
</div>
