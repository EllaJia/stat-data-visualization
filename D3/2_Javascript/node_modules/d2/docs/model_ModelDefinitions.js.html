...
<head>
    <meta charset="utf-8">
    <title>model/ModelDefinitions.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/ModelDefinitions.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { checkType, isType } from '../lib/check';
