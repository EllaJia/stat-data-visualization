...
<head>
    <meta charset="utf-8">
    <title>model/Model.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/Model.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { checkType, hasKeys } from '../lib/check';
