...
<head>
    <meta charset="utf-8">
    <title>model/ModelCollection.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/ModelCollection.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { isValidUid, isArray, checkType } from '../lib/check';
