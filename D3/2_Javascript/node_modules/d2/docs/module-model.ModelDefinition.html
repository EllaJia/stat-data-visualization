...
<head>
    <meta charset="utf-8">
    <title>ModelDefinition - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ModelDefinition</h1>
...
<header>
        ...
        ModelDefinition
            ...
            <div class="class-description"><p>Definition of a Model. Basically this object contains the meta data related to the Model. Like <code>name</code>, <code>apiEndPoint</code>, <code>modelValidation</code>, etc.
It also has methods to create and load Models that are based on this definition. The Data element <code>ModelDefinition</code> would be used to create Data Element <code>Model</code>s</p>
<p>Note: ModelDefinition has a property <code>api</code> that is used for the communication with the dhis2 api. The value of this
property is an instance of <code>Api</code>.</p></div>
...
<article>
    ...
    <h4 class="name" id="ModelDefinition"><span class="type-signature"></span>new ModelDefinition<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line129">line 129</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".createFromSchema"><span class="type-signature">(static) </span>createFromSchema<span class="signature">(schema, attributes)</span><span class="type-signature"> &rarr; {ModelDefinition}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line405">line 405</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>ModelDefinition.createFromSchema(schemaDefinition, attributes);</code></pre>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>A schema definition received from the web api (/api/schemas)</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Object></span>
            ...
            <td class="description last"><p>A list of attribute objects that describe custom attributes (/api/attributes)</p></td>
        </tr>
...
<div class="param-desc">
    <p>Frozen model definition object.</p>
</div>
...
<span class="param-type">ModelDefinition</span>
    ...
    <h4 class="name" id="create"><span class="type-signature"></span>create<span class="signature">(data<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Model}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line174">line 174</a>
    </li></ul></dd>
...
<div class="description">
    <p>Creates a fresh Model instance based on the <code>ModelDefinition</code>. If data is passed into the method that
data will be loaded into the matching properties of the model.</p>
</div>
    ...
    <pre class="prettyprint"><code>dataElement.create({name: 'ANC', id: 'd2sf33s3ssf'});</code></pre>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Data values that should be loaded into the model.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns the newly created model instance.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line348">line 348</a>
    </li></ul></dd>
...
<div class="description">
    <p>This method is used by the <code>Model</code> instances to delete the model when calling <code>model.delete()</code>.</p>
</div>
...
<div class="param-desc">
    <p>Returns a promise to the deletion operation</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="get"><span class="type-signature"></span>get<span class="signature">(identifier, queryParams<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line239">line 239</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get a <code>Model</code> instance from the api loaded with data that relates to <code>identifier</code>.
This will do an API call and return a Promise that resolves with a <code>Model</code> or rejects with the api error message.</p>
</div>
    ...
    <pre class="prettyprint"><code>//Do a get request for the dataElement with given id (d2sf33s3ssf) and print it's name
//when that request is complete and the model is loaded.
dataElement.get('d2sf33s3ssf')
  .then(model => console.log(model.name));</code></pre>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Query parameters that should be passed to the GET query.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Resolves with a <code>Model</code> instance or an error message.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getOwnedPropertyNames"><span class="type-signature"></span>getOwnedPropertyNames<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;String>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line336">line 336</a>
    </li></ul></dd>
...
<div class="description">
    <p>This method returns a list of property names that that are defined
as &quot;owner&quot; properties on this schema. This means these properties are used
when saving the model to the server.</p>
</div>
    ...
    <pre class="prettyprint"><code>dataElement.getOwnedPropertyNames()</code></pre>
...
<span class="param-type">Array.&lt;String></span>
    ...
    <h4 class="name" id="getTranslatableProperties"><span class="type-signature"></span>getTranslatableProperties<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;String>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line369">line 369</a>
    </li></ul></dd>
...
<div class="description">
    <p>These properties can be translated using the DHIS2 <em>database</em> translations.</p>
</div>
...
<div class="param-desc">
    <p>Returns a list of property names on the object that are translatable.</p>
</div>
...
<span class="param-type">Array.&lt;String></span>
    ...
    <h4 class="name" id="getTranslatablePropertiesWithKeys"><span class="type-signature"></span>getTranslatablePropertiesWithKeys<span class="signature">()</span><span class="type-signature"> &rarr; {Array.&lt;Object>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line381">line 381</a>
    </li></ul></dd>
...
<div class="description">
    <p>This method is similar to getTranslatableProperties() but in addition to the property names also returns the
<code>translationKey</code> that is used to save the translations for the property names.</p>
</div>
...
<div class="param-desc">
    <p>Returns an array with objects that have <code>name</code> and <code>translationKey</code> properties.</p>
</div>
...
<span class="param-type">Array.&lt;Object></span>
    ...
    <h4 class="name" id="isTranslatable"><span class="type-signature"></span>isTranslatable<span class="signature">()</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line360">line 360</a>
    </li></ul></dd>
...
<div class="description">
    <p>Check for if the Model supports translations</p>
</div>
...
<div class="param-desc">
    <p>True when the schema can be translated, false otherwise</p>
</div>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="list"><span class="type-signature"></span>list<span class="signature">(listParams<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line271">line 271</a>
    </li></ul></dd>
...
<div class="description">
    ...
    <pre class="prettyprint"><code>// Loads a list of models and prints their name.
dataElement.list()
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>listParams</code></td>
...
<div class="param-desc">
    <p>ModelCollection collection of models objects of the <code>ModelDefinition</code> type.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="save"><span class="type-signature"></span>save<span class="signature">(model)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelDefinition.js.html">model/ModelDefinition.js</a>, <a href="model_ModelDefinition.js.html#line304">line 304</a>
    </li></ul></dd>
...
<div class="description">
    <p>This method is used by the <code>Model</code> instances to save the model when calling <code>model.save()</code>.</p>
</div>
...
<span class="param-type">Model</span>
            ...
            <td class="description last"><p>The model that should be saved to the server.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A promise which resolves when the save was successful
