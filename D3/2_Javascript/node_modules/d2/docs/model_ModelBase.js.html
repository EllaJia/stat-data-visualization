...
<head>
    <meta charset="utf-8">
    <title>model/ModelBase.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">model/ModelBase.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import ModelValidation from './ModelValidation';
