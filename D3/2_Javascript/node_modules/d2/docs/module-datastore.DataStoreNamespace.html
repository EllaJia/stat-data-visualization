...
<head>
    <meta charset="utf-8">
    <title>DataStoreNamespace - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">DataStoreNamespace</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-datastore.html">datastore</a>.</span>
...
<article>
    ...
    <h4 class="name" id="DataStoreNamespace"><span class="type-signature"></span>new DataStoreNamespace<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_DataStoreNamespace.js.html">datastore/DataStoreNamespace.js</a>, <a href="datastore_DataStoreNamespace.js.html#line14">line 14</a>
    </li></ul></dd>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>an array of the loaded keys.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Name of the namespace as on the server.</p></td>
        </tr>
...
<div class="description">
    <p>Represents a namespace in the dataStore that can be used to be used to interact with
the remote API.</p>
</div>
    ...
    <ul>
        <li><a href="module-datastore.BaseStoreNamespace.html">module:datastore.BaseStoreNamespace</a></li>
    </ul>
...
<h4 class="name" id="keys"><span class="type-signature"></span>keys<span class="type-signature"> :Array.&lt;string></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line45">line 45</a>
    </li></ul></dd>
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#keys">module:datastore.BaseStoreNamespace#keys</a>
    </li></ul></dd>
...
<div class="description">
    <p>an array of the loaded keys.</p>
</div>
...
<h4 class="name" id="namespace"><span class="type-signature"></span>namespace<span class="type-signature"> :string</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line39">line 39</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#namespace">module:datastore.BaseStoreNamespace#namespace</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="delete"><span class="type-signature"></span>delete<span class="signature">(key)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line103">line 103</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#delete">module:datastore.BaseStoreNamespace#delete</a>
    </li></ul></dd>
...
<div class="description">
    <p>Deletes given key from the API.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>key to delete.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>the response body from the <a href="module-api.Api.html#get">API</a>.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="get"><span class="type-signature"></span>get<span class="signature">(key)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line70">line 70</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#get">module:datastore.BaseStoreNamespace#get</a>
    </li></ul></dd>
...
<div class="description">
    <p>Retrieves the value of given key in current namespace.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>key to retrieve.</p></td>
        </tr>
...
<div class="param-desc">
    <ul>
<li>The value of the given key.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getKeys"><span class="type-signature"></span>getKeys<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line54">line 54</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#getKeys">module:datastore.BaseStoreNamespace#getKeys</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get the keys for this namespace.</p>
</div>
...
<div class="param-desc">
    <ul>
<li>The internal list of keys for current namespace.</li>
</ul>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getMetaData"><span class="type-signature"></span>getMetaData<span class="signature">(key)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_DataStoreNamespace.js.html">datastore/DataStoreNamespace.js</a>, <a href="datastore_DataStoreNamespace.js.html#line24">line 24</a>
    </li></ul></dd>
...
<div class="description">
    <p>Retrieves metaData of given key in current namespace.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>the key to retrieve metaData for.</p></td>
        </tr>
    ...
    <h4 class="name" id="set"><span class="type-signature"></span>set<span class="signature">(key, value, overrideUpdate<span class="signature-attributes">opt</span>, encrypt<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line87">line 87</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#set">module:datastore.BaseStoreNamespace#set</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sets the value of given key to given value.</p>
<p>This will also create a new namespace on the API-end if it does not exist.
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>key in this namespace to set.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>JSON-value to be set.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>overrideUpdate</code></td>
            ...
            <td class="description last"><p>If true a post-request is sent even if key exists.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>If the value should be encrypted on the server.</p></td>
        </tr>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="update"><span class="type-signature"></span>update<span class="signature">(key, value)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="datastore_BaseStoreNamespace.js.html">datastore/BaseStoreNamespace.js</a>, <a href="datastore_BaseStoreNamespace.js.html#line119">line 119</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="module-datastore.BaseStoreNamespace.html#update">module:datastore.BaseStoreNamespace#update</a>
    </li></ul></dd>
...
<div class="description">
    <p>Updates a key with given value.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>key to update.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>value to update to.</p></td>
        </tr>
