...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-system.html">system</a>.</span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line19">line 19</a>
    </li></ul></dd>
...
<div class="description">
    <p>Represents the system that can be interacted with. There is a single instance of this pre-defined onto the d2
object after initialisation. This can be interacted with using its property objects to among other be used
to get and save systemSettings.</p>
</div>
...
<h4 class="name" id="configuration"><span class="type-signature"></span>configuration<span class="type-signature"> :SystemConfiguration</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line41">line 41</a>
    </li></ul></dd>
...
<div class="description">
    <p>A representation of the system configuration,
that can be used to retrieve and change system configuration options.</p>
</div>
...
<span class="param-type">SystemConfiguration</span>
...
<h4 class="name" id="installedApps"><span class="type-signature"></span>installedApps<span class="type-signature"> :Array</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line59">line 59</a>
    </li></ul></dd>
...
<div class="description">
    <p>An array of all the webapps that are installed on the current DHIS2 instance</p>
</div>
...
<h4 class="name" id="settings"><span class="type-signature"></span>settings<span class="type-signature"> :SystemSettings</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="description">
    <p>Contains a reference to a <code>SystemSettings</code> instance that can be used
to retrieve and save system settings.</p>
<pre class="prettyprint source lang-js"><code>d2.system.settings.get('keyLastSuccessfulResourceTablesUpdate')
...
<span class="param-type">SystemSettings</span>
...
<h4 class="name" id="systemInfo"><span class="type-signature"></span>systemInfo<span class="type-signature"> :Object</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line47">line 47</a>
    </li></ul></dd>
...
<div class="description">
    <p>An object containing system information about the DHIS2 instance</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line53">line 53</a>
    </li></ul></dd>
...
<div class="description">
    <p>An object containing version information about the DHIS2 instance</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id=".compareVersions"><span class="type-signature">(static) </span>compareVersions<span class="signature">(a, b)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line224">line 224</a>
    </li></ul></dd>
...
<div class="description">
    <p>Compares version a to version b.</p>
</div>
...
<span class="param-type"><a href="module-system.html#.ParsedVersion">module:system.ParsedVersion</a></span>
...
<div class="param-desc">
    <p>0 if same version, else a - b.</p>
</div>
...
<span class="param-type">number</span>
    ...
    <h4 class="name" id=".getSystem"><span class="type-signature">(static) </span>getSystem<span class="signature">()</span><span class="type-signature"> &rarr; {System}</span></h4>
...
<div class="description">
    <p>Get a new instance of the system object. This will function as a singleton, when a System object has been created
when requesting getSystem again the original version will be returned.</p>
</div>
...
<div class="param-desc">
    <p>Object with the system interaction properties</p>
</div>
...
<span class="param-type">System</span>
    ...
    <h4 class="name" id=".isVersionCompatible"><span class="type-signature">(static) </span>isVersionCompatible<span class="signature">(systemVersion, appVersion)</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line245">line 245</a>
    </li></ul></dd>
...
<div class="description">
    <p>Checks if systemVersion is compatible with appVersion.
Versions are compatible if appVersion.minDhisVersion &lt;= parsed systemVersion and
if appVersion.maxDhisVersion &gt;= parsed systemVersion.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>systemVersion</code></td>
...
<span class="param-type"><a href="module-system.html#.ParsedVersion">module:system.ParsedVersion</a></span>
            ...
            <td class="description last"><p>systemVersion to check</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>AppVersion object to check</p></td>
        </tr>
...
<span class="param-type">boolean</span>
    ...
    <h4 class="name" id=".parseVersionString"><span class="type-signature">(static) </span>parseVersionString<span class="signature">(version)</span><span class="type-signature"> &rarr; {<a href="module-system.html#.ParsedVersion">module:system.ParsedVersion</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line208">line 208</a>
    </li></ul></dd>
...
<div class="description">
    <p>Parses a version string into an object describing the version.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Version-string to parse</p></td>
        </tr>
...
<span class="param-type"><a href="module-system.html#.ParsedVersion">module:system.ParsedVersion</a></span>
    ...
    <h4 class="name" id="installAppVersion"><span class="type-signature"></span>installAppVersion<span class="signature">(uid)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line159">line 159</a>
    </li></ul></dd>
...
<div class="description">
    <p>Install the specified app version from the DHIS 2 app store</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The uid of the app version to install</p></td>
        </tr>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="loadAppStore"><span class="type-signature"></span>loadAppStore<span class="signature">(compatibleOnly)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line132">line 132</a>
    </li></ul></dd>
...
<div class="description">
    <p>Load the list of apps available in the DHIS 2 app store</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>compatibleOnly</code></td>
            ...
            <td class="description last"><p>If true, apps that are incompatible with the current system will be filtered out</p></td>
        </tr>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="loadInstalledApps"><span class="type-signature"></span>loadInstalledApps<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line86">line 86</a>
    </li></ul></dd>
...
<div class="description">
    <p>Refreshes the list of currently installed webapps</p>
</div>
...
<div class="param-desc">
    <p>A promise that resolves to the list of installed apps</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="reloadApps"><span class="type-signature"></span>reloadApps<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line189">line 189</a>
    </li></ul></dd>
...
<div class="description">
    <p>Refresh the list of apps that are installed on the server</p>
</div>
...
<div class="param-desc">
    <p>A promise that resolves to the updated list of installed apps</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="setInstalledApps"><span class="type-signature"></span>setInstalledApps<span class="signature">(apps)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line77">line 77</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sets the list of currently installed webapps</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>apps</code></td>
    ...
    <h4 class="name" id="setSystemInfo"><span class="type-signature"></span>setSystemInfo<span class="signature">(systemInfo)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line67">line 67</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sets the systemInfo and version properties</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>systemInfo</code></td>
    ...
    <h4 class="name" id="uninstallApp"><span class="type-signature"></span>uninstallApp<span class="signature">(appKey)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line176">line 176</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove the specified app from the system</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The key of the app to remove</p></td>
        </tr>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="uploadApp"><span class="type-signature"></span>uploadApp<span class="signature">(zipFile, onProgress)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="system_System.js.html">system/System.js</a>, <a href="system_System.js.html#line104">line 104</a>
    </li></ul></dd>
...
<div class="description">
    <p>Upload and install a zip file containing a new webapp</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>Zip file data from a file input form field</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>An optional callback that will be called whenever file upload progress info is available</p></td>
        </tr>
