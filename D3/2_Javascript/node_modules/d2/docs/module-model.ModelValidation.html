...
<head>
    <meta charset="utf-8">
    <title>ModelValidation - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ModelValidation</h1>
...
<header>
        ...
        ModelValidation
            ...
            <div class="class-description"><p>Handles validation of Model objects based on their modelDefinition.</p></div>
...
<article>
    ...
    <h4 class="name" id="ModelValidation"><span class="type-signature"></span>new ModelValidation<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelValidation.js.html">model/ModelValidation.js</a>, <a href="model_ModelValidation.js.html#line11">line 11</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".getModelValidation"><span class="type-signature">(static) </span>getModelValidation<span class="signature">()</span><span class="type-signature"> &rarr; {ModelValidation}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelValidation.js.html">model/ModelValidation.js</a>, <a href="model_ModelValidation.js.html#line67">line 67</a>
    </li></ul></dd>
...
<div class="description">
    <p>Returns the <code>ModelValidation</code> singleton. Creates a new one if it does not yet exist.
Grabs a logger instance by calling <code>Logger.getLogger</code></p>
</div>
...
<div class="param-desc">
    <p>New or memoized instance of <code>ModelInstance</code></p>
</div>
...
<span class="param-type">ModelValidation</span>
    ...
    <h4 class="name" id="validate"><span class="type-signature"></span>validate<span class="signature">()</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelValidation.js.html">model/ModelValidation.js</a>, <a href="model_ModelValidation.js.html#line22">line 22</a>
    </li></ul></dd>
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>Client side model validation is deprecated in favour of server side validation only.</li></ul></dd>
...
<div class="param-desc">
    <p>Returns {status: true, messages: []}</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="validateAgainstSchema"><span class="type-signature"></span>validateAgainstSchema<span class="signature">(model)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="model_ModelValidation.js.html">model/ModelValidation.js</a>, <a href="model_ModelValidation.js.html#line35">line 35</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sends a POST request against the <code>api/schemas</code> endpoint to check if the model is valid.</p>
</div>
...
<span class="param-type">Model</span>
            ...
            <td class="description last"><p>The model that should be validated.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Returns an array with validation messages if there are any.</p>
</div>
