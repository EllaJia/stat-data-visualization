...
<head>
    <meta charset="utf-8">
    <title>Pager - Documentation</title>
...
<article>
    ...
    <h4 class="name" id="Pager"><span class="type-signature"></span>new Pager<span class="signature">(pager<span class="signature-attributes">opt</span>, pagingHandler<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="description">
    <p>Returns a newly created pager object with methods to navigate pages.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>pager</code></td>
...
<span class="param-type">Object</span>
                ...
                <td class="default">
                    ...
                    <code>{page: 1, pageCount: 1}</code>
                
                </td>
            

            <td class="description last"><p>Paging information object.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>pagingHandler</code></td>
...
<span class="param-type">Object</span>
                ...
                <td class="default">
                    ...
                    <code>{list: () => Promise.reject('No handler available')}</code>
                
                </td>
            

            <td class="description last"><p>Paging handler object. The requirement for this object is that it has a list method.</p></td>
        </tr>
...
<h4 class="name" id="nextPage"><span class="type-signature"></span>nextPage<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line53">line 53</a>
    </li></ul></dd>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>nextPage</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The url to the next page.</p></td>
        </tr>
...
<div class="description">
    <p>If there is no next page then this will be undefined.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line31">line 31</a>
    </li></ul></dd>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Current page number</p></td>
        </tr>
...
<h4 class="name" id="pageCount"><span class="type-signature"></span>pageCount<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line36">line 36</a>
    </li></ul></dd>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The total number of pages available</p></td>
        </tr>
...
<h4 class="name" id="prevPage"><span class="type-signature"></span>prevPage<span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line61">line 61</a>
    </li></ul></dd>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>prevPage</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The url to the previous page</p></td>
        </tr>
...
<div class="description">
    <p>If there is no previous page then this will be undefined.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line70">line 70</a>
    </li></ul></dd>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>Query parameters</p></td>
        </tr>
...
<div class="description">
    <p>Query parameters are used for things like filtering and field selection. Used to guarantee that pages are
from the same collection.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line45">line 45</a>
    </li></ul></dd>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The total number of items available.</p></td>
        </tr>
...
<div class="description">
    <p>This represents the total number of items available in the system. Note it is not the number of items
on the current page.</p>
    ...
    <h4 class="name" id="getNextPage"><span class="type-signature"></span>getNextPage<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line111">line 111</a>
    </li></ul></dd>
...
<div class="description">
    <p>Loads the next page in the collection if there is one. If no additional pages are available the Promise will reject.</p>
</div>
    ...
    <pre class="prettyprint"><code>d2.models.organisationUnit
  .list()
  .then(collection => {
...
<div class="param-desc">
    <p>Promise that resolves with a new <code>ModelCollection</code> containing the next page's data. Or rejects with
a string when there is no next page for this collection or when the request for the next page failed.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getPreviousPage"><span class="type-signature"></span>getPreviousPage<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line136">line 136</a>
    </li></ul></dd>
...
<div class="description">
    <p>Loads the previous page in the collection if there is one. If no previous pages are available the Promise will reject.</p>
</div>
...
<div class="param-desc">
    <p>Promise that resolves with a new <code>ModelCollection</code> containing the previous page's data. Or rejects with
a string when there is no previous page for this collection or when the request for the previous page failed.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="goToPage"><span class="type-signature"></span>goToPage<span class="signature">(pageNr)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line161">line 161</a>
    </li></ul></dd>
...
<div class="description">
    <p>Loads a specific page for the collection. If the requested page is out of the range of available pages (e.g &lt; 0 or &gt; page count)
the Promise will reject with an error.</p>
</div>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The number of the page you wish to navigate to.</p></td>
        </tr>
...
<div class="param-desc">
    <p>Promise that resolves with a new <code>ModelCollection</code> containing the data for the requested page.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="hasNextPage"><span class="type-signature"></span>hasNextPage<span class="signature">()</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line81">line 81</a>
    </li></ul></dd>
...
<div class="description">
    <p>Check whether there is a next page.</p>
</div>
...
<div class="param-desc">
    <p>Result is true when there is a next page, false when there is not.</p>
</div>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="hasPreviousPage"><span class="type-signature"></span>hasPreviousPage<span class="signature">()</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="pager_Pager.js.html">pager/Pager.js</a>, <a href="pager_Pager.js.html#line90">line 90</a>
    </li></ul></dd>
...
<div class="description">
    <p>Check whether there is a previous page.</p>
</div>
...
<div class="param-desc">
    <p>Result is true when there is a previous page, false when there is not.</p>
</div>
